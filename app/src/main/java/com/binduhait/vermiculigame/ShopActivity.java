...
//                WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        shopP2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if (coins >= 30 && gold_coin >= 60){
                    shop2 = true;
                    action = 2;
                    coins = coins - 30;
                    gold_coin = gold_coin - 60;
        ...
        shopP3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if (coins >= 50 && gold_coin >= 100){
                    shop3 = true;
                    action = 3;
                    coins = coins - 50;
                    gold_coin = gold_coin - 100;
        ...
        shopP4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if (coins >= 80 && gold_coin >= 160){
                    shop4 = true;
                    action = 4;
                    coins = coins - 80;
                    gold_coin = gold_coin - 160;
